...
########################################################################################################################
### Get TagLib
FROM --platform=$BUILDPLATFORM public.ecr.aws/docker/library/alpine:3.23 AS taglib-build
ARG TARGETPLATFORM
ARG CROSS_TAGLIB_VERSION=2.1.2
ENV CROSS_TAGLIB_RELEASES_URL=https://github.com/MichaIng/cross-taglib/releases/download/v${CROSS_TAGLIB_VERSION}/
